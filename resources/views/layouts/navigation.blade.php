    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                class="relative p-2 text-gray-500 hover:text-gray-700 transition duration-150 ease-in-out rounded-full hover:bg-gray-100">
                    <!-- Icono de Campana -->
                    ...
                    <!-- Indicador: solo aparece si hay notificaciones sin leer -->
                    @if($unread->count() > 0)
