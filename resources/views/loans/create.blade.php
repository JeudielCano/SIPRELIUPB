                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                                ...
                                <div>
                                    <label for="return_time" class="block mb-2 text-sm font-medium text-gray-900">Hora de Devolución</label>
                                    <div class="relative">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Debe devolverse el mismo día del retiro.</p>
                                </div>
                            </div>
        ...
        function loanForm() {
            return {
                ...
                updateDueDate() {
                    ...
                    if (this.pickupDate && this.returnTime) {
                        const datePart = this.pickupDate.split('T')[0];
                        this.dueDate = datePart + 'T' + this.returnTime;
                    } else {
                        this.dueDate = '';
                    }
                },
                ...
                validateDates() {
                    ...
                    if (due <= pickup) {
                        this.dateError = 'La hora de devolución debe ser posterior a la de retiro.';
                        return;
                    }
